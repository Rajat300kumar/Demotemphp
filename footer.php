          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-delay="0.2s">
              ...
              <div class="col-lg-4 m-3">
                <p>Address</p>
                <span class="">
                  <p class="">Contact:-<a href="tel:9958073192">+91 - 9958073192</a></p>
                  <p class="">Email:-<a href="mailto:admin@vereda.co.in">admin@vereda.co.in</a></p>
                  <p class="">Website:-<a href="/">https://www.vereda.co.in</a></p>
                </span>
              </div>
            </div>
